  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-10 -left-10 w-[360px] h-[360px] rounded-full bg-gradient-to-r from-black via-gray-700 to-yellow-400 opacity-20 blur-[120px] animate-pulse" />
        <div className="absolute bottom-0 right-10 w-[420px] h-[420px] rounded-full bg-gradient-to-r from-yellow-400 via-gray-600 to-black opacity-15 blur-[140px] animate-pulse delay-300" />
      ...
      <div className="relative  z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-10 flex  flex-col gap-12">
        ...
        >
          {/* image card */}
          <motion.div
            className="relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-full overflow-hidden shadow-2xl 
                       bg-gradient-to-br from-yellow-400/20 to-gray-600/20 
                       border border-yellow-400/30"
            whileHover={{ scale: 1.02 }}
            transition={{ type: "spring", stiffness: 200, damping: 18 }}
            aria-hidden="true"
          >
            <img src={deep} alt="deep-photo" />
          </motion.div>
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left ">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              <a
                href="#projects"
                className="inline-flex items-center justify-center rounded-lg bg-yellow-400 text-black font-semibold px-5 py-3 hover:bg-yellow-300 transition"
              >
                View Projects
              </a>
              <a
